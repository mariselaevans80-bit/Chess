public static class PieceSquareTables
{
    ...
    public static int GetPST(PieceType type, PieceColor color, int col, int row, bool isEndgame)
    {
        int tableRow = (color == PieceColor.White) ? row : (7 - row);
        int index = tableRow * 8 + col;

        int[] table = type switch
        {
            PieceType.Pawn   => Pawn,
